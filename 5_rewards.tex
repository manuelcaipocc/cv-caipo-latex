...
% Premio 1 — Triple Award Freeport
\footnotesize 2022 & 
...
\emph{Machine \& Deep Learning Life Data Analysis} mit messbarem Impact (+1.5 \% Anlagenverfügbarkeit, ≈>10 M USD/Jahr). &
\cert{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/rewards/rewards_innova.pdf} 
\\[0.2em]

% Premio 2 — Outstanding Thesis
\footnotesize 2021 & 
\footnotesize \textbf{Auszeichnung für herausragende Bachelorarbeit} – Ingenieurwissenschaften. &
\cert{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/rewards/Public_contratulations_thesis.pdf} \\[0.2em]

% Premio 3 — Top Student
\footnotesize 2019 & 
\footnotesize \textbf{Bester Absolvent (Top 1 \%)} – Maschinenbau, Universidad Nacional de San Agustín, Peru. &
\cert{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/unsa_bachelor/Beste_note_student.pdf} \\[-0.5em]
