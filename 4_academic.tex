...
\setlength{\colA}{2.4cm}  % Fecha
\setlength{\colD}{0.3cm}  % Columna para [i], [ii], etc.
...
\noindent
\begin{tabular}{@{}%
  >{\centering\arraybackslash}m{\colA}      % Fecha (vertical centrado, horizontal derecha)
  @{\hspace{1em}}%
...
%---------- MSc 1 ----------
\footnotesize 10.2025 -- Heute &
\raisebox{0.28ex}{\href{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/uni_ulm_master/Certificate_of_semesters_of_enrolment.pdf}{\tiny[i]}} &
\footnotesize \textbf{Master of Science – Computational Science and Engineering} &
\footnotesize — \\[-0.15em]

& & \footnotesize \textit{Focus: 
%Numerical Optimization, 
High-Performance Computing, Theoretical Computer Science} & \\[-0.15em]
...
% ---------- MSc 2 ----------
\footnotesize 09.2024 -- 02.2026 &
\raisebox{0.28ex}{\href{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/hfu_master/HFU_grades.pdf}{\tiny[i]}} &
\footnotesize \textbf{Master of Science – Advanced Precision Engineering} &
\footnotesize 1,59\\[-0.15em] &  &
...
\raisebox{1.55ex} {\href{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/hfu_master/M_Sc__Thesis_APE_Manuel_Caipo.pdf}{\tiny[ii]}} &
...
\textcolor{mygrey}{\tiny [Top 5\,\%]}   \footnotesize 19.6/20.0\\[-0.6em]& &
...
&\raisebox{0.28ex}{\href{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/unsa_bachelor/Anerkennung_maschinenbau_manuel_caipo.pdf}{\tiny[ii]}} &
\footnotesize \textit{Anerkennung durch die Regierung von Schwaben.} & \\
& \raisebox{0.28ex}{\href{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/unsa_bachelor/Beste_note_student.pdf}{\tiny[iii]}} &
...
% \raisebox{0.30ex}{\href{https://manuelcaipocc.github.io/cv-caipo-latex/cv_links/school_sekundar/sekundarstufe_HZB.pdf}{\tiny[i]}} &
...
\textcolor{linksoft}{\textit{Hinweise:} \tiny[i] Diplom-/Programmstatus ansehen.}}\\[-0.2em]
% \multicolumn{4}{@{}r@{}}{\tiny 
