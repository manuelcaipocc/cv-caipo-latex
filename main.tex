...
\usepackage[top=1.5cm, bottom=0.5cm, left=1.5cm, right=2cm]{geometry}
...
%   urlcolor   = linksoft,
%   citecolor  = linksoft,
%   pdftitle={Manuel Caipo - CV},
%   pdfauthor={Manuel Caipo},
...
\newcommand{\resheading}[1]{%
  \phantomsection % Crea el ancla para el link sin saltar de página
  \addcontentsline{toc}{section}{#1} % Agrega el título al árbol del PDF
  \begingroup
...
\newcommand{\FancyQRBottom}{%
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[
      ...
      \begingroup
        \color{qrcolor}
        \qrcode[height=10mm]{https://manuelcaipocc.github.io/}%
...
\AddToHook{shipout/background}{\FancyTopbar}
\AddToHook{shipout/background}{\FancyQRBottom}
...
\resheading{PUBLICATIONS}\\[\lsepe]
\vspace{0.4em}

\input{9_publications}
