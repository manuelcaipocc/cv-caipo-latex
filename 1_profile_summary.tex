...
\begin{tabular}{p{\linewidth}}
  ...
  \justifying
    \cellcolor{cvbackgroundgray}
     \noindent Maschinenbauingenieur und Machine-Learning-Spezialist mit Schwerpunkt auf physik-informierter Modellierung und KI-gestützter Zustandsüberwachung industrieller cyber-physischer Systeme. Starke analytische Kompetenz in der Interpretation von Sensordynamiken, der Analyse physikalischer Degradationsmechanismen sowie in der Entwicklung physikalisch konsistenter ML-Ansätze für skalierbare Condition-Monitoring-Lösungen.
Erfahrung in der Modellierung industrieller Zeitreihen, Datenpipeline-Automatisierung und Systemintegration. Aktuell verstärkt forschungsorientierter Fokus auf strukturierte, topologiebasierte Systemrepräsentationen und theoretisch fundierte, interpretierbare KI-Modelle für komplexe technische Architekturen.
\end{tabular}
