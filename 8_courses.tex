...
\begin{minipage}[t]{\linewidth}\vspace{0pt}
  ...
  2024 & Deutschkurse B1, B2, C1 (\inst{https://www.vh-ulm.de/}{Ulm vhs} \& \inst{https://www.berlitz.de}{Berlitz}) & \cert{https://example.com/zertifikat} \\[\RowTight]
  2022 & Führung und Soft Skills (\inst{https://www.ucsp.edu.pe}{UCSP}) & \cert{https://example.com/zertifikat} \\[\RowTight]
  2022 & SQL (\inst{https://www.newhorizons.com}{New Horizons}) & \cert{https://example.com/zertifikat} \\[\RowTight]
  2021 & Python für Data Science (\inst{https://www.socialdataconsulting.com}{SDC}) & \cert{https://example.com/zertifikat} \\[\RowTight]
  2021 & Hydrauliksysteme (\inst{https://www.boschrexroth.com}{Bosch Rexroth}) & \cert{https://example.com/zertifikat} \\[\RowTight]
  2019 & Calculation of Pipelines (\inst{https://www.eadic.com}{EADIC}) & \cert{https://example.com/zertifikat} \\[\RowTight]
